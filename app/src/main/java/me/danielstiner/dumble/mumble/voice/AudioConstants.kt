 ...
 *  twins, not a shared definition; see the note there. The playout engine is not a third twin:
 *  these are handed to it through PlayoutEngine::create, so it has nothing of its own to drift. */
