 ...
 * reads under the same mutex once per fill.
 */
...
public:
     ...
     * error. `frameNumber` is the packet's first frame, `samples` its duration and never
     * negative, `arrivalMillis` a BOOTTIME reading.
     *
