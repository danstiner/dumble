...
class FakePlayoutEngine : VoiceReceiver.PlayoutEngine {
    ...
    /** A talk spurt: [count] consecutive producing fills from one speaker. Speaking state from a
     *  single fill lasts one write and can be conflated away before a test's collector sees it. */
